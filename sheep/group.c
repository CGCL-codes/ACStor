				    ...
				    size_t nr_nodes)
{
	...
	vnode_info->my_nr_vnodes = my_nodes_to_vnodes(vnode_info->nodes, nr_nodes, vnode_info->my_vnodes);
	//PRINT_TO_LOG("exec here\n");
...
void recalculate_vnodes(struct sd_node *nodes, int nr_nodes)
{
	...
	for (i = 0; i < nr_nodes; i++) {
		...
		//nodes[i].nr_vnodes = tmp;
		//nodes[i].my_nr_vnodes = tmp;
		//tmp += 10;
	...
	//180,40
	/*
	nodes[0].my_nr_vnodes = nodes[0].nr_vnodes = 61;
	nodes[1].my_nr_vnodes = nodes[1].nr_vnodes = 66;
	nodes[2].my_nr_vnodes = nodes[2].nr_vnodes = 61;
	nodes[3].my_nr_vnodes = nodes[3].nr_vnodes = 72;
	nodes[4].my_nr_vnodes = nodes[4].nr_vnodes = 61;
	nodes[5].my_nr_vnodes = nodes[5].nr_vnodes = 80;
	nodes[6].my_nr_vnodes = nodes[6].nr_vnodes = 72;
	nodes[7].my_nr_vnodes = nodes[7].nr_vnodes = 55;
	nodes[8].my_nr_vnodes = nodes[8].nr_vnodes = 66;
	nodes[9].my_nr_vnodes = nodes[9].nr_vnodes = 88;
	nodes[10].my_nr_vnodes = nodes[10].nr_vnodes = 47;
	nodes[11].my_nr_vnodes = nodes[11].nr_vnodes = 64;
	nodes[12].my_nr_vnodes = nodes[12].nr_vnodes = 66;
	nodes[13].my_nr_vnodes = nodes[13].nr_vnodes = 114;
	nodes[14].my_nr_vnodes = nodes[14].nr_vnodes = 72;
	nodes[15].my_nr_vnodes = nodes[15].nr_vnodes = 145;
	nodes[16].my_nr_vnodes = nodes[16].nr_vnodes = 80;
	nodes[17].my_nr_vnodes = nodes[17].nr_vnodes = 123;
	nodes[18].my_nr_vnodes = nodes[18].nr_vnodes = 80;
	nodes[19].my_nr_vnodes = nodes[19].nr_vnodes = 88;
	nodes[20].my_nr_vnodes = nodes[20].nr_vnodes = 114;
	nodes[21].my_nr_vnodes = nodes[21].nr_vnodes = 123;
	nodes[22].my_nr_vnodes = nodes[22].nr_vnodes = 145;
	nodes[23].my_nr_vnodes = nodes[23].nr_vnodes = 500;
	nodes[24].my_nr_vnodes = nodes[24].nr_vnodes = 400;
	nodes[25].my_nr_vnodes = nodes[25].nr_vnodes = 200;
	nodes[26].my_nr_vnodes = nodes[26].nr_vnodes = 114;
	nodes[27].my_nr_vnodes = nodes[27].nr_vnodes = 160;
	nodes[28].my_nr_vnodes = nodes[28].nr_vnodes = 160;
	nodes[29].my_nr_vnodes = nodes[29].nr_vnodes = 106;
	nodes[30].my_nr_vnodes = nodes[30].nr_vnodes = 80;
	nodes[31].my_nr_vnodes = nodes[31].nr_vnodes = 94;*/
	//180,80
	/*nodes[0].my_nr_vnodes = nodes[0].nr_vnodes = 34;
	nodes[1].my_nr_vnodes = nodes[1].nr_vnodes = 72;
	nodes[2].my_nr_vnodes = nodes[2].nr_vnodes = 44;
	nodes[3].my_nr_vnodes = nodes[3].nr_vnodes = 80;
	nodes[4].my_nr_vnodes = nodes[4].nr_vnodes = 40;
	nodes[5].my_nr_vnodes = nodes[5].nr_vnodes = 100;
	nodes[6].my_nr_vnodes = nodes[6].nr_vnodes = 80;
	nodes[7].my_nr_vnodes = nodes[7].nr_vnodes = 33;
	nodes[8].my_nr_vnodes = nodes[8].nr_vnodes = 72;
	nodes[9].my_nr_vnodes = nodes[9].nr_vnodes = 133;
	nodes[10].my_nr_vnodes = nodes[10].nr_vnodes = 29;
	nodes[11].my_nr_vnodes = nodes[11].nr_vnodes = 44;
	nodes[12].my_nr_vnodes = nodes[12].nr_vnodes = 50;
	nodes[13].my_nr_vnodes = nodes[13].nr_vnodes = 200;
	nodes[14].my_nr_vnodes = nodes[14].nr_vnodes = 72;
	nodes[15].my_nr_vnodes = nodes[15].nr_vnodes = 266;
	nodes[16].my_nr_vnodes = nodes[16].nr_vnodes = 100;
	nodes[17].my_nr_vnodes = nodes[17].nr_vnodes = 200;
	nodes[18].my_nr_vnodes = nodes[18].nr_vnodes = 88;
	nodes[19].my_nr_vnodes = nodes[19].nr_vnodes = 100;
	nodes[20].my_nr_vnodes = nodes[20].nr_vnodes = 200;
	nodes[21].my_nr_vnodes = nodes[21].nr_vnodes = 200;
	nodes[22].my_nr_vnodes = nodes[22].nr_vnodes = 266;
	nodes[23].my_nr_vnodes = nodes[23].nr_vnodes = 1600;
	nodes[24].my_nr_vnodes = nodes[24].nr_vnodes = 1600;
	nodes[25].my_nr_vnodes = nodes[25].nr_vnodes = 1600;
	nodes[26].my_nr_vnodes = nodes[26].nr_vnodes = 200;
	nodes[27].my_nr_vnodes = nodes[27].nr_vnodes = 400;
	nodes[28].my_nr_vnodes = nodes[28].nr_vnodes = 266;
	nodes[29].my_nr_vnodes = nodes[29].nr_vnodes = 160;
	nodes[30].my_nr_vnodes = nodes[30].nr_vnodes = 100;
	nodes[31].my_nr_vnodes = nodes[31].nr_vnodes = 133;*/
	//180.120
	/*nodes[0].my_nr_vnodes = nodes[0].nr_vnodes = 39;
	nodes[1].my_nr_vnodes = nodes[1].nr_vnodes = 88;
	nodes[2].my_nr_vnodes = nodes[2].nr_vnodes = 44;
	nodes[3].my_nr_vnodes = nodes[3].nr_vnodes = 88;
	nodes[4].my_nr_vnodes = nodes[4].nr_vnodes = 39;
	nodes[5].my_nr_vnodes = nodes[5].nr_vnodes = 118;
	nodes[6].my_nr_vnodes = nodes[6].nr_vnodes = 118;
	nodes[7].my_nr_vnodes = nodes[7].nr_vnodes = 20;
	nodes[8].my_nr_vnodes = nodes[8].nr_vnodes = 59;
	nodes[9].my_nr_vnodes = nodes[9].nr_vnodes = 177;
	nodes[10].my_nr_vnodes = nodes[10].nr_vnodes = 16;
	nodes[11].my_nr_vnodes = nodes[11].nr_vnodes = 59;
	nodes[12].my_nr_vnodes = nodes[12].nr_vnodes = 59;
	nodes[13].my_nr_vnodes = nodes[13].nr_vnodes = 177;
	nodes[14].my_nr_vnodes = nodes[14].nr_vnodes = 88;
	nodes[15].my_nr_vnodes = nodes[15].nr_vnodes = 355;
	nodes[16].my_nr_vnodes = nodes[16].nr_vnodes = 118;
	nodes[17].my_nr_vnodes = nodes[17].nr_vnodes = 355;
	nodes[18].my_nr_vnodes = nodes[18].nr_vnodes = 118;
	nodes[19].my_nr_vnodes = nodes[19].nr_vnodes = 118;
	nodes[20].my_nr_vnodes = nodes[20].nr_vnodes = 177;
	nodes[21].my_nr_vnodes = nodes[21].nr_vnodes = 355;
	nodes[22].my_nr_vnodes = nodes[22].nr_vnodes = 355;
	nodes[23].my_nr_vnodes = nodes[23].nr_vnodes = 1600;
	nodes[24].my_nr_vnodes = nodes[24].nr_vnodes = 1600;
	nodes[25].my_nr_vnodes = nodes[25].nr_vnodes = 1600;
	nodes[26].my_nr_vnodes = nodes[26].nr_vnodes = 355;
	nodes[27].my_nr_vnodes = nodes[27].nr_vnodes = 1600;
	nodes[28].my_nr_vnodes = nodes[28].nr_vnodes = 1600;
	nodes[29].my_nr_vnodes = nodes[29].nr_vnodes = 177;
	nodes[30].my_nr_vnodes = nodes[30].nr_vnodes = 118;
	nodes[31].my_nr_vnodes = nodes[31].nr_vnodes = 177;*/
	//380,40
	/*nodes[0].my_nr_vnodes = nodes[0].nr_vnodes = 27;
	nodes[1].my_nr_vnodes = nodes[1].nr_vnodes = 34;
	nodes[2].my_nr_vnodes = nodes[2].nr_vnodes = 32;
	nodes[3].my_nr_vnodes = nodes[3].nr_vnodes = 36;
	nodes[4].my_nr_vnodes = nodes[4].nr_vnodes = 28;
	nodes[5].my_nr_vnodes = nodes[5].nr_vnodes = 40;
	nodes[6].my_nr_vnodes = nodes[6].nr_vnodes = 36;
	nodes[7].my_nr_vnodes = nodes[7].nr_vnodes = 24;
	nodes[8].my_nr_vnodes = nodes[8].nr_vnodes = 33;
	nodes[9].my_nr_vnodes = nodes[9].nr_vnodes = 40;
	nodes[10].my_nr_vnodes = nodes[10].nr_vnodes = 23;
	nodes[11].my_nr_vnodes = nodes[11].nr_vnodes = 33;
	nodes[12].my_nr_vnodes = nodes[12].nr_vnodes = 33;
	nodes[13].my_nr_vnodes = nodes[13].nr_vnodes = 47;
	nodes[14].my_nr_vnodes = nodes[14].nr_vnodes = 34;
	nodes[15].my_nr_vnodes = nodes[15].nr_vnodes = 57;
	nodes[16].my_nr_vnodes = nodes[16].nr_vnodes = 38;
	nodes[17].my_nr_vnodes = nodes[17].nr_vnodes = 50;
	nodes[18].my_nr_vnodes = nodes[18].nr_vnodes = 38;
	nodes[19].my_nr_vnodes = nodes[19].nr_vnodes = 40;
	nodes[20].my_nr_vnodes = nodes[20].nr_vnodes = 42;
	nodes[21].my_nr_vnodes = nodes[21].nr_vnodes = 53;
	nodes[22].my_nr_vnodes = nodes[22].nr_vnodes = 66;
	nodes[23].my_nr_vnodes = nodes[23].nr_vnodes = 320;
	nodes[24].my_nr_vnodes = nodes[24].nr_vnodes = 266;
	nodes[25].my_nr_vnodes = nodes[25].nr_vnodes = 160;
	nodes[26].my_nr_vnodes = nodes[26].nr_vnodes = 40;
	nodes[27].my_nr_vnodes = nodes[27].nr_vnodes = 160;
	nodes[28].my_nr_vnodes = nodes[28].nr_vnodes = 66;
	nodes[29].my_nr_vnodes = nodes[29].nr_vnodes = 42;
	nodes[30].my_nr_vnodes = nodes[30].nr_vnodes = 38;
	nodes[31].my_nr_vnodes = nodes[31].nr_vnodes = 42;*/
	//380,80
	/*nodes[0].my_nr_vnodes = nodes[0].nr_vnodes = 16;
	nodes[1].my_nr_vnodes = nodes[1].nr_vnodes = 30;
	nodes[2].my_nr_vnodes = nodes[2].nr_vnodes = 23;
	nodes[3].my_nr_vnodes = nodes[3].nr_vnodes = 37;
	nodes[4].my_nr_vnodes = nodes[4].nr_vnodes = 18;
	nodes[5].my_nr_vnodes = nodes[5].nr_vnodes = 57;
	nodes[6].my_nr_vnodes = nodes[6].nr_vnodes = 42;
	nodes[7].my_nr_vnodes = nodes[7].nr_vnodes = 15;
	nodes[8].my_nr_vnodes = nodes[8].nr_vnodes = 27;
	nodes[9].my_nr_vnodes = nodes[9].nr_vnodes = 57;
	nodes[10].my_nr_vnodes = nodes[10].nr_vnodes = 15;
	nodes[11].my_nr_vnodes = nodes[11].nr_vnodes = 23;
	nodes[12].my_nr_vnodes = nodes[12].nr_vnodes = 25;
	nodes[13].my_nr_vnodes = nodes[13].nr_vnodes = 88;
	nodes[14].my_nr_vnodes = nodes[14].nr_vnodes = 30;
	nodes[15].my_nr_vnodes = nodes[15].nr_vnodes = 123;
	nodes[16].my_nr_vnodes = nodes[16].nr_vnodes = 48;
	nodes[17].my_nr_vnodes = nodes[17].nr_vnodes = 123;
	nodes[18].my_nr_vnodes = nodes[18].nr_vnodes = 48;
	nodes[19].my_nr_vnodes = nodes[19].nr_vnodes = 57;
	nodes[20].my_nr_vnodes = nodes[20].nr_vnodes = 69;
	nodes[21].my_nr_vnodes = nodes[21].nr_vnodes = 123;
	nodes[22].my_nr_vnodes = nodes[22].nr_vnodes = 123;
	nodes[23].my_nr_vnodes = nodes[23].nr_vnodes = 533;  
	nodes[24].my_nr_vnodes = nodes[24].nr_vnodes = 533;  
	nodes[25].my_nr_vnodes = nodes[25].nr_vnodes = 533;   
	nodes[26].my_nr_vnodes = nodes[26].nr_vnodes = 123;
	nodes[27].my_nr_vnodes = nodes[27].nr_vnodes = 123;
	nodes[28].my_nr_vnodes = nodes[28].nr_vnodes = 123;
	nodes[29].my_nr_vnodes = nodes[29].nr_vnodes = 69;
	nodes[30].my_nr_vnodes = nodes[30].nr_vnodes = 48;
	nodes[31].my_nr_vnodes = nodes[31].nr_vnodes = 57;*/
	//380,120
	/*nodes[0].my_nr_vnodes = nodes[0].nr_vnodes = 15;
	nodes[1].my_nr_vnodes = nodes[1].nr_vnodes = 16;
	nodes[2].my_nr_vnodes = nodes[2].nr_vnodes = 15;
	nodes[3].my_nr_vnodes = nodes[3].nr_vnodes = 50;
	nodes[4].my_nr_vnodes = nodes[4].nr_vnodes = 15;
	nodes[5].my_nr_vnodes = nodes[5].nr_vnodes = 80;
	nodes[6].my_nr_vnodes = nodes[6].nr_vnodes = 80;
	nodes[7].my_nr_vnodes = nodes[7].nr_vnodes = 15;
	nodes[8].my_nr_vnodes = nodes[8].nr_vnodes = 15;
	nodes[9].my_nr_vnodes = nodes[9].nr_vnodes = 80;
	nodes[10].my_nr_vnodes = nodes[10].nr_vnodes = 15;
	nodes[11].my_nr_vnodes = nodes[11].nr_vnodes = 15;
	nodes[12].my_nr_vnodes = nodes[12].nr_vnodes = 15;
	nodes[13].my_nr_vnodes = nodes[13].nr_vnodes = 800;
	nodes[14].my_nr_vnodes = nodes[14].nr_vnodes = 16;
	nodes[15].my_nr_vnodes = nodes[15].nr_vnodes = 800;
	nodes[16].my_nr_vnodes = nodes[16].nr_vnodes = 80;
	nodes[17].my_nr_vnodes = nodes[17].nr_vnodes = 800;
	nodes[18].my_nr_vnodes = nodes[18].nr_vnodes = 80;
	nodes[19].my_nr_vnodes = nodes[19].nr_vnodes = 80;
	nodes[20].my_nr_vnodes = nodes[20].nr_vnodes = 114;
	nodes[21].my_nr_vnodes = nodes[21].nr_vnodes = 800;
	nodes[22].my_nr_vnodes = nodes[22].nr_vnodes = 800;
	nodes[23].my_nr_vnodes = nodes[23].nr_vnodes = 800;
	nodes[24].my_nr_vnodes = nodes[24].nr_vnodes = 800;
	nodes[25].my_nr_vnodes = nodes[25].nr_vnodes = 800;
	nodes[26].my_nr_vnodes = nodes[26].nr_vnodes = 800;
	nodes[27].my_nr_vnodes = nodes[27].nr_vnodes = 800;
	nodes[28].my_nr_vnodes = nodes[28].nr_vnodes = 800;
	nodes[29].my_nr_vnodes = nodes[29].nr_vnodes = 114;
	nodes[30].my_nr_vnodes = nodes[30].nr_vnodes = 80;
	nodes[31].my_nr_vnodes = nodes[31].nr_vnodes = 80;*/
	/*32,160,avr=300,var=25
	[32, 44, 36, 44, 34, 50, 47, 30, 42, 53, 29, 36, 40, 66, 44, 88, 47, 72, 47, 50, 66, 72, 88, 400, 200, 160, 72, 133, 114, 61, 47, 53]*/
	/*nodes[0].my_nr_vnodes = nodes[0].nr_vnodes = 32;
	nodes[1].my_nr_vnodes = nodes[1].nr_vnodes = 44;
	nodes[2].my_nr_vnodes = nodes[2].nr_vnodes = 36;
	nodes[3].my_nr_vnodes = nodes[3].nr_vnodes = 44;
	nodes[4].my_nr_vnodes = nodes[4].nr_vnodes = 34;
	nodes[5].my_nr_vnodes = nodes[5].nr_vnodes = 50;
	nodes[6].my_nr_vnodes = nodes[6].nr_vnodes = 47;
	nodes[7].my_nr_vnodes = nodes[7].nr_vnodes = 30;
	nodes[8].my_nr_vnodes = nodes[8].nr_vnodes = 42;
	nodes[9].my_nr_vnodes = nodes[9].nr_vnodes = 53;
	nodes[10].my_nr_vnodes = nodes[10].nr_vnodes = 29;
	nodes[11].my_nr_vnodes = nodes[11].nr_vnodes = 36;
	nodes[12].my_nr_vnodes = nodes[12].nr_vnodes = 40;
	nodes[13].my_nr_vnodes = nodes[13].nr_vnodes = 66;
	nodes[14].my_nr_vnodes = nodes[14].nr_vnodes = 44;
	nodes[15].my_nr_vnodes = nodes[15].nr_vnodes = 88;
	nodes[16].my_nr_vnodes = nodes[16].nr_vnodes = 47;
	nodes[17].my_nr_vnodes = nodes[17].nr_vnodes = 72;
	nodes[18].my_nr_vnodes = nodes[18].nr_vnodes = 47;
	nodes[19].my_nr_vnodes = nodes[19].nr_vnodes = 50;
	nodes[20].my_nr_vnodes = nodes[20].nr_vnodes = 66;
	nodes[21].my_nr_vnodes = nodes[21].nr_vnodes = 72;
	nodes[22].my_nr_vnodes = nodes[22].nr_vnodes = 88;
	nodes[23].my_nr_vnodes = nodes[23].nr_vnodes = 400;
	nodes[24].my_nr_vnodes = nodes[24].nr_vnodes = 200;
	nodes[25].my_nr_vnodes = nodes[25].nr_vnodes = 160;
	nodes[26].my_nr_vnodes = nodes[26].nr_vnodes = 72;
	nodes[27].my_nr_vnodes = nodes[27].nr_vnodes = 133;
	nodes[28].my_nr_vnodes = nodes[28].nr_vnodes = 114;
	nodes[29].my_nr_vnodes = nodes[29].nr_vnodes = 61;
	nodes[30].my_nr_vnodes = nodes[30].nr_vnodes = 47;
	nodes[31].my_nr_vnodes = nodes[31].nr_vnodes = 53;*/
	/* 32,160,avr=300,var50,change 16000 to 1000
	[20, 33, 28, 38, 22, 76, 44, 19, 33, 88, 19, 29, 29, 133, 35, 177, 53, 133, 53, 88, 133, 177, 266, 16000, 533, 533, 133, 266, 266, 106, 76, 88]*/
	/*nodes[0].my_nr_vnodes = nodes[0].nr_vnodes = 20;
	nodes[1].my_nr_vnodes = nodes[1].nr_vnodes = 33;
	nodes[2].my_nr_vnodes = nodes[2].nr_vnodes = 28;
	nodes[3].my_nr_vnodes = nodes[3].nr_vnodes = 38;
	nodes[4].my_nr_vnodes = nodes[4].nr_vnodes = 22;
	nodes[5].my_nr_vnodes = nodes[5].nr_vnodes = 76;
	nodes[6].my_nr_vnodes = nodes[6].nr_vnodes = 44;
	nodes[7].my_nr_vnodes = nodes[7].nr_vnodes = 19;
	nodes[8].my_nr_vnodes = nodes[8].nr_vnodes = 33;
	nodes[9].my_nr_vnodes = nodes[9].nr_vnodes = 88;
	nodes[10].my_nr_vnodes = nodes[10].nr_vnodes = 19;
	nodes[11].my_nr_vnodes = nodes[11].nr_vnodes = 29;
	nodes[12].my_nr_vnodes = nodes[12].nr_vnodes = 29;
	nodes[13].my_nr_vnodes = nodes[13].nr_vnodes = 133;
	nodes[14].my_nr_vnodes = nodes[14].nr_vnodes = 35;
	nodes[15].my_nr_vnodes = nodes[15].nr_vnodes = 177;
	nodes[16].my_nr_vnodes = nodes[16].nr_vnodes = 53;
	nodes[17].my_nr_vnodes = nodes[17].nr_vnodes = 133;
	nodes[18].my_nr_vnodes = nodes[18].nr_vnodes = 53;
	nodes[19].my_nr_vnodes = nodes[19].nr_vnodes = 88;
	nodes[20].my_nr_vnodes = nodes[20].nr_vnodes = 133;
	nodes[21].my_nr_vnodes = nodes[21].nr_vnodes = 177;
	nodes[22].my_nr_vnodes = nodes[22].nr_vnodes = 266;
	nodes[23].my_nr_vnodes = nodes[23].nr_vnodes = 1000;
	nodes[24].my_nr_vnodes = nodes[24].nr_vnodes = 533;
	nodes[25].my_nr_vnodes = nodes[25].nr_vnodes = 533;
	nodes[26].my_nr_vnodes = nodes[26].nr_vnodes = 133;
	nodes[27].my_nr_vnodes = nodes[27].nr_vnodes = 266;
	nodes[28].my_nr_vnodes = nodes[28].nr_vnodes = 266;
	nodes[29].my_nr_vnodes = nodes[29].nr_vnodes = 106;
	nodes[30].my_nr_vnodes = nodes[30].nr_vnodes = 76;
	nodes[31].my_nr_vnodes = nodes[31].nr_vnodes = 88;*/
	/*32,160,avr=300,var=75
	[17, 40, 20, 53, 20, 160, 80, 15, 40, 160, 15, 32, 40, 160, 40, 16000, 80, 16000, 80, 160, 160, 16000, 16000, 16000, 16000, 16000, 16000, 16000, 16000, 160, 80, 160]*/
	/*nodes[0].my_nr_vnodes = nodes[0].nr_vnodes = 17;
 	nodes[1].my_nr_vnodes = nodes[1].nr_vnodes = 40;
	nodes[2].my_nr_vnodes = nodes[2].nr_vnodes = 20;
	nodes[3].my_nr_vnodes = nodes[3].nr_vnodes = 53;
	nodes[4].my_nr_vnodes = nodes[4].nr_vnodes = 20;
	nodes[5].my_nr_vnodes = nodes[5].nr_vnodes = 160;
	nodes[6].my_nr_vnodes = nodes[6].nr_vnodes = 80;
	nodes[7].my_nr_vnodes = nodes[7].nr_vnodes = 15;
	nodes[8].my_nr_vnodes = nodes[8].nr_vnodes = 40;
	nodes[9].my_nr_vnodes = nodes[9].nr_vnodes = 160;
	nodes[10].my_nr_vnodes = nodes[10].nr_vnodes = 15;
	nodes[11].my_nr_vnodes = nodes[11].nr_vnodes = 32;
	nodes[12].my_nr_vnodes = nodes[12].nr_vnodes = 40;
	nodes[13].my_nr_vnodes = nodes[13].nr_vnodes = 160;
	nodes[14].my_nr_vnodes = nodes[14].nr_vnodes = 40;
	nodes[15].my_nr_vnodes = nodes[15].nr_vnodes = 1600;
	nodes[16].my_nr_vnodes = nodes[16].nr_vnodes = 80;
	nodes[17].my_nr_vnodes = nodes[17].nr_vnodes = 1600;
	nodes[18].my_nr_vnodes = nodes[18].nr_vnodes = 80;
	nodes[19].my_nr_vnodes = nodes[19].nr_vnodes = 160;
	nodes[20].my_nr_vnodes = nodes[20].nr_vnodes = 160;
	nodes[21].my_nr_vnodes = nodes[21].nr_vnodes = 1600;
	nodes[22].my_nr_vnodes = nodes[22].nr_vnodes = 1600;
	nodes[23].my_nr_vnodes = nodes[23].nr_vnodes = 1600;
	nodes[24].my_nr_vnodes = nodes[24].nr_vnodes = 1600;
	nodes[25].my_nr_vnodes = nodes[25].nr_vnodes = 1600;
	nodes[26].my_nr_vnodes = nodes[26].nr_vnodes = 1600;
	nodes[27].my_nr_vnodes = nodes[27].nr_vnodes = 1600;
	nodes[28].my_nr_vnodes = nodes[28].nr_vnodes = 1600;
	nodes[29].my_nr_vnodes = nodes[29].nr_vnodes = 160;
	nodes[30].my_nr_vnodes = nodes[30].nr_vnodes = 80;
	nodes[31].my_nr_vnodes = nodes[31].nr_vnodes = 160;*/
